...
public class ShootAndReturnHome extends SequentialCommandGroup {
    ...
    public ShootAndReturnHome(ShooterSubsystem shooter, ArmSubsystem arm, DoubleSupplier topSpeed, DoubleSupplier bottomSpeed) {
        addCommands(
            new SpinUpAndShoot(shooter, topSpeed, bottomSpeed),
            new MoveToHome(arm)
        );
    }
