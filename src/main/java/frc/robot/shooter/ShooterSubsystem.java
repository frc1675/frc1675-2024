...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private void ShuffleboardInit() {
    ...
    tab.addDouble("Target Bottom Shooter Speed", () -> targetBottomShooterSpeed).withPosition(0, 1).withSize(2, 1);
    ...
    tab.addBoolean("Shooter Ready?", () -> isShooterReady()).withPosition(3, 2).withSize(3, 3);
    tab.addBoolean("Has Note?", () -> isIndexerLoaded()).withPosition(6, 1).withSize(4, 4);

    tab.addDouble("Target Indexer Speed", () -> targetIndexerSpeed).withPosition(0, 2).withSize(2, 1);
    ...
    tab.addDouble("LaserCAN Measurement", () -> shooterIO.getMeasurement()).withPosition(0, 3).withSize(2, 1);
  }
